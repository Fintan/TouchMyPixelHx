...
touchmypixel.geom.Triangulator.triangulateFromFlatArray = function(vx,vy) {
	...
	while(vNum > 3) {
		...
		if(earIndex == -1) {
			haxe.Log.trace("Error: No ear found!",{ fileName : "Triangulator.hx", lineNumber : 77, className : "touchmypixel.geom.Triangulator", methodName : "triangulateFromFlatArray"});
			{
				$s.pop();
				return null;
			}
...
fboyle.layout.FlaBox2dLayoutExport = function(p) { if( p === $_ ) return; {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::new");
	var $spos = $s.length;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseResults = function(results) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseResults");
	var $spos = $s.length;
	var xml = "";
	{
		var _g = 0;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseParameters = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseParameters");
	var $spos = $s.length;
	var sc = result.scope;
	var xml = "";
	xml += " name=\"" + sc.name + "\"";
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseLayout = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseLayout");
	var $spos = $s.length;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseGameObject = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseGameObject");
	var $spos = $s.length;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseBody = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseBody");
	var $spos = $s.length;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseEmpty = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseEmpty");
	var $spos = $s.length;
	var sc = result.scope;
	var xml = "<empty";
	xml += " name=\"" + sc.name + "\"";
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseMovieClipParameters = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseMovieClipParameters");
	var $spos = $s.length;
	var sc = result.scope;
	var xml = "";
	xml += " name=\"" + sc.name + "\"";
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseMovieClip = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseMovieClip");
	var $spos = $s.length;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseBitmap = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseBitmap");
	var $spos = $s.length;
	var linkageID;
	var itemName = StringTools.replace(result.scope.libraryItem.name,"-","/");
	if(result.scope.libraryItem.linkageClassName == null) {
		haxe.Log.trace("Warning: " + result.scope.libraryItem.name + " has no linkage id",{ fileName : "FlaBox2dLayoutExport.hx", lineNumber : 351, className : "fboyle.layout.FlaBox2dLayoutExport", methodName : "parseBitmap"});
		linkageID = itemName;
	}
	else {
		linkageID = StringTools.replace(result.scope.libraryItem.linkageClassName,"-","/");
	}
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseShape = function(result) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseShape");
	var $spos = $s.length;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseElements = function(scope) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseElements");
	var $spos = $s.length;
	var xml = "";
	{
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseElementCircle = function(s) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseElementCircle");
	var $spos = $s.length;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseElementRect = function(s) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseElementRect");
	var $spos = $s.length;
...
fboyle.layout.FlaBox2dLayoutExport.prototype.parseElementPoly = function(s,scope) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::parseElementPoly");
	var $spos = $s.length;
	var xml = "";
	...
	if(lastPoint.x != points[0].x || lastPoint.y != points[0].y) haxe.Log.trace("WARNING: shape not closed: " + scope.name + " [" + scope.libraryItem.linkageClassName + "]",{ fileName : "FlaBox2dLayoutExport.hx", lineNumber : 512, className : "fboyle.layout.FlaBox2dLayoutExport", methodName : "parseElementPoly"});
	else points.pop();
...
fboyle.layout.FlaBox2dLayoutExport.prototype.searchTimeline = function(inScope,store) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::searchTimeline");
	var $spos = $s.length;
	var results = [];
	{
		...
		while(_g < _g1.length) {
			...
			if(touchmypixel.game.utils.JSFLTools.isInstance(el)) {
				...
				else if(touchmypixel.game.utils.JSFLTools.isShape(el1)) null;
			}
		}
	}
	{
...
fboyle.layout.FlaBox2dLayoutExport.prototype.saveXml = function(xml) {
	$s.push("fboyle.layout.FlaBox2dLayoutExport::saveXml");
	var $spos = $s.length;
	var path = this.doc.pathURI;
	path = path.substr(0,path.lastIndexOf("."));
	path += ".xml";
	haxe.Log.trace("EXPORTED: " + path,{ fileName : "FlaBox2dLayoutExport.hx", lineNumber : 631, className : "fboyle.layout.FlaBox2dLayoutExport", methodName : "saveXml"});
